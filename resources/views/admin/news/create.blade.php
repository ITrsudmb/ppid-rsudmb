...
<div class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div class="bg-white p-8 rounded-xl shadow w-full max-w-2xl">
        <h2 class="text-2xl font-bold text-blue-700 mb-4">Tambah Berita Baru</h2>
        ...
        <form method="POST" action="{{ route('admin.news.store') }}" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea name="isi" rows="6" class="w-full border-gray-300 rounded p-2" required></textarea>
            </div>
